...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.5, 377.0, 52.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 519.315460205078125, 46.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 218.0, 5.571006774902344, 38.0, 21.0 ],
					"text" : "alpha",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 482.0, 684.823303000000124, 41.0, 127.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 423.0, 40.25, 41.0, 162.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 6.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 769.0, 99.0, 92.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 75.678993225097656, 88.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.5, 426.5, 47.0, 30.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 99.678993225097656, 58.0, 18.0 ],
					"text" : "difference",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 423.5, 275.5, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 284.5, 103.5, 30.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 688.333312999999976, 332.5, 68.0, 14.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 502.333373999999992, 226.0, 60.0, 14.0 ],
					"presentation" : 1,
