...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "upshot_waveslope.maxpat",
					"numinlets" : 4,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 0.0, 208.0, 191.0 ],
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-27" : [ "wfg2_wf", "waveform", 0 ],
			"obj-1::obj-11" : [ "rslider", "rslider", 0 ],
			"obj-1::obj-2" : [ "speed", "speed", 0 ],
			"obj-1::obj-3" : [ "output", "output", 0 ],
			"parameterbanks" : 			{
