...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "upshot_colortracking.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 0.0, 0.0, 453.0, 228.0 ],
					"varname" : "upshot_colortracking",
					"viewvisibility" : 1
				}
		...
		"parameters" : 		{
			...
			"obj-1::obj-9" : [ "width", "width", 0 ],
			"obj-1::obj-23" : [ "open input", "open input", 0 ],
