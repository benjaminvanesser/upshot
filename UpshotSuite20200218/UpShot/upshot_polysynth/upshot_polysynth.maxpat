...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.583333333333371, 798.0, 150.0, 33.0 ],
					"text" : "inspired by tutorials by Peter Batchelor (2010)"
				}

			}
, 			{
				"box" : 				{
					"comment" : "oscillator (0-127)",
					"id" : "obj-8",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1283.333333333333485, 409.029937744140625, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1283.333333333333485, 449.10723876953125, 90.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1404.833333333333485, 536.922698974609375, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1404.833333333333485, 574.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 69.571428571428555, 41.571006774902344, 60.0, 19.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 578.209523809523716, 554.0, 56.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.571428571428555, 41.571006774902344, 64.0, 18.0 ],
					"text" : "wave shape",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 69.571428571428555, 40.571006774902344, 60.0, 20.0 ],
					"varname" : "wave-type"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 747.238095238095184, 513.0, 56.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.571428571428555, 67.571006774902344, 37.0, 18.0 ],
					"text" : "carrier",
					"textcolor" : [ 0.4274509804, 0.8431372549, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 532.833333333333371, 312.0, 53.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.571428571428555, 152.0, 53.0, 18.0 ],
					"text" : "modulator",
					"textcolor" : [ 0.4274509804, 0.8431372549, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ fmsynthpoly.maxpat 30 @ steal 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 454.333333333333371, 250.0, 42.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 91.029937744140625, 41.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 511.833333333333371, 250.0, 43.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 135.166666666666629, 91.029937744140625, 43.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 398.833333333333371, 250.0, 43.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 91.029937744140625, 43.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 3.33333,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 342.333333333333371, 250.0, 43.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 91.029937744140625, 43.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 3.33333,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 472.180952380952363, 448.0, 48.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 233.166666666666742, 174.029937744140625, 48.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 408.666666666666629, 448.0, 39.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 196.738095238095184, 174.029937744140625, 39.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 640.72380952380945, 452.0, 42.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 94.571428571428555, 174.029937744140625, 41.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 726.238095238095184, 452.0, 43.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 137.738095238095184, 174.029937744140625, 43.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 3.33333,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 599.20952380952383, 452.0, 43.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.571428571428555, 174.029937744140625, 43.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 3.33333,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 535.695238095238096, 452.0, 40.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.571428571428555, 174.029937744140625, 40.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 3.33333,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 276.0, 648.0, 47.0, 136.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 216.238095238095184, 41.571006774902344, 47.0, 116.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -70.0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"hint" : "polyphonic synth, based on Peter Batchelor's sunth tutorials",
					"id" : "obj-1456",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.0, 116.922698974609375, 65.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 114.5, 5.571006774902344, 67.0, 20.0 ],
					"text" : "polysynth",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 1292.833333333333485, 539.553619384765625, 484.5, 539.553619384765625 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1414.333333333333485, 641.5, 285.5, 641.5 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 208.5, 541.5, 484.5, 541.5 ],
					"order" : 0,
					"source" : [ "obj-84", 0 ]
				}
