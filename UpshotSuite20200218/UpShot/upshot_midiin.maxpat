...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"hint" : "select MIDI input device and separate RAW MIDI data into standard MIDI messages",
					"id" : "obj-1456",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 73.0, 56.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 68.431551218032837, 5.996506571769714, 51.0, 20.0 ],
					"text" : "MIDI in",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 369.5, 184.0, 56.0, 29.0 ],
					"presentation" : 1,
