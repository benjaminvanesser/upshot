...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.439453125, 110.727203369140625, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.439453125, 61.727203369140625, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 309.773111979166686, 72.7786865234375, 56.0, 22.0 ],
					"restore" : 					{
						"state" : [ 0 ],
						"volume" : [ 0.0 ]
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 207.3720703125, 369.4632568359375, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 175.3720703125, 369.4632568359375, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 395.3583984375, 64.7786865234375, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.779541015625, 114.42510986328125, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.439453125, 114.42510986328125, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -2.0, 28.571006774902344, 150.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hint" : "freeze audio; based on Jean Francois Charles's stochastic freeze",
					"id" : "obj-1456",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.439453125, 47.594146728515625, 54.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.5, 5.571006774902344, 42.0, 21.0 ],
					"text" : "freeze",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 548.439453125, 335.4632568359375, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.439453125, 361.4632568359375, 83.0, 22.0 ],
					"text" : "range -0.3 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.06787109375, 369.4632568359375, 77.0, 22.0 ],
					"text" : "loadmess 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.439453125, 304.4632568359375, 87.0, 22.0 ],
					"text" : "loadmess 110"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 367.06787109375, 410.0157470703125, 137.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.676320850849152, 73.926788330078125, 96.818617165088654, 45.0 ],
					"range" : [ -0.3, 0.3 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 322.1064453125, 132.92510986328125, 44.0, 14.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 322.1064453125, 120.92510986328125, 48.0, 17.0 ],
					"text" : "fade time",
...
,
					"patching_rect" : [ 175.439453125, 202.01568603515625, 62.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 175.3720703125, 232.58209228515625, 64.0, 62.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 106.2183837890625, 44.38177490234375, 34.0, 75.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -70.0,
...
,
					"patching_rect" : [ 175.439453125, 165.0157470703125, 239.00048828125, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 395.3583984375, 124.92510986328125, 82.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.676320850849152, 44.38177490234375, 96.818617165088654, 28.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.439453125, 4.727203369140625, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 0.071014404296875, 149.0, 127.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 404.93994140625, 194.015716552734375, 227.939453125, 194.015716552734375 ],
					"source" : [ "obj-1481", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 196.1220703125, 351.798919677734375, 376.56787109375, 351.798919677734375 ],
					"order" : 0,
					"source" : [ "obj-1757", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 184.8720703125, 351.798919677734375, 376.56787109375, 351.798919677734375 ],
					"order" : 0,
					"source" : [ "obj-1757", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 196.1220703125, 351.378082275390625, 216.8720703125, 351.378082275390625 ],
					"order" : 1,
					"source" : [ "obj-1757", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 184.8720703125, 316.378082275390625, 184.8720703125, 316.378082275390625 ],
					"order" : 1,
					"source" : [ "obj-1757", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 557.939453125, 330.739501953125, 494.56787109375, 330.739501953125 ],
					"order" : 2,
					"source" : [ "obj-1817", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1807", 0 ],
					"midpoints" : [ 557.939453125, 396.239501953125, 376.56787109375, 396.239501953125 ],
					"order" : 1,
					"source" : [ "obj-1871", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1757", 0 ],
					"midpoints" : [ 537.939453125, 227.154647827148438, 184.8720703125, 227.154647827148438 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1414" : [ "state", "state", 0 ],
			"obj-1757" : [ "volume", "vol", 0 ],
			"obj-1758" : [ "fade-time", "fade-time", 0 ],
			"parameterbanks" : 			{
