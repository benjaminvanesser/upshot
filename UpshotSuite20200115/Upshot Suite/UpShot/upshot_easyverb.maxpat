...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.5, 107.571006774902344, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 222.045394897460938, 57.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.462142944335938, 191.475677490234375, 5.0, 100.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 28.571006774902344, 118.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.962142944335938, 184.342620849609375, 54.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 26.5, 5.571006774902344, 60.0, 21.0 ],
					"text" : "easy verb",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.588851928710938, 57.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.784506225585915, 57.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.013961791992188, 565.44970703125, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.545394897460938, 565.44970703125, 30.0, 30.0 ]
				}
...
,
					"patching_rect" : [ 213.083251953125, 431.72137451171875, 62.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 211.545394897460938, 477.0, 51.0, 62.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 67.893213907877566, 42.579193115234375, 34.0, 84.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 431.0, 136.0, 56.0, 22.0 ],
					"restore" : 					{
						"bypass" : [ 0.0 ],
						"yafr-decay" : [ 78.999999999999972 ],
						"yafr-size" : [ 127.0 ],
						"yafr-vol" : [ 0.0 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 251.0, 163.0, 27.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.5, 65.079193115234375, 45.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 218.5, 163.0, 27.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					"color" : [ 0.839216, 0.564258, 0.825339, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-103",
					"maxclass" : "newobj",
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 205.0, 218.653197999999975, 73.0, 22.0 ],
					"text" : "yafr2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.462142944335938, 167.52716064453125, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.071014404296875, 117.0, 137.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 260.5, 213.826598999999987, 241.5, 213.826598999999987 ],
					"source" : [ "obj-111", 0 ]
				}
