...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.5, 99.342620849609375, 54.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 104.5, 4.571006774902344, 44.0, 21.0 ],
					"text" : "reverb",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 448.9736328125, 487.0, 64.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 156.376953125, 82.0, 64.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 437.53125, 446.0, 64.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 43.376953125, 82.0, 64.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
							"parameter_unitstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 426.0888671875, 402.0, 64.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.876953125, 38.0, 68.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
							"parameter_unitstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 416.646484375, 361.0, 45.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 165.876953125, 38.0, 45.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
							"parameter_unitstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 405.2041015625, 320.0, 45.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.876953125, 82.0, 45.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
							"parameter_unitstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 393.76171875, 279.0, 45.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.876953125, 38.0, 45.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
							"parameter_unitstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 382.3193359375, 238.0, 45.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 106.376953125, 82.0, 45.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
							"parameter_unitstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 370.876953125, 191.0, 39.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.876953125, 38.0, 39.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
							"parameter_unitstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 356.9736328125, 594.60791015625, 110.0, 105.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 324.869140625, 577.803955078125, 457.4736328125, 577.803955078125 ],
					"source" : [ "obj-33", 1 ]
				}
